...
adata,pred_dsc = STMSGAL.train_STMSGAL(adata, alpha=alpha, pre_resolution=pre_resolution,
                              ...
                              n_cluster = dsc_cluster,reg_ssc_coef = reg_ssc_coef,cost_ssc_coef = cost_ssc_coef,
...
parameter = f"2_rad_cutoff={rad_cutoff},alpha={alpha}," \
            f"pre_resolution={pre_resolution},n_epochs={n_epochs}" \
            f"reg_ssc={reg_ssc_coef},cost_ssc = {cost_ssc_coef},eval_resolution = {np.round(eval_resolution,3)}" \
